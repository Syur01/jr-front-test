...
const HttpStatusChecker: React.FC = () => {
  ...
  const [trafficLightStatus, setTrafficLightStatus] =
    useState<TrafficLightStatus>("off");
  ...
  const checkStatusCode = () => {
    ...
    const hasForbiddenSymbol = forbiddenSymbols.some((symbol) =>
      inputValue.includes(symbol)
    );
    const afterProtocol = inputValue.replace(/^https?:\/\//, "");
